        ...
        <div class="container-fluid">
            <div class="row">
                <div class="text-center col-12">
                    <h1 class="page-title">Customer Register</h1>
                    <ul class="breadcrumb justify-content-center">
                        <li><a href="index.html">Home</a></li>
                        <li class="current"><span>Customer Register</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row pt--75 pt-md--55 pt-sm--35 pb--80 pb-md--60 pb-sm--40">
                    <div class="m-auto col-md-6 mb-sm--30">
                        <div class="login-box">
                            ...
                            @endif
                            <form class="form form--login" action="{{ route('customer.register.store') }}" method="POST">
                                @csrf
