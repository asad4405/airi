                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href="{{ route('password.reset.request',$token) }}" target="_blank"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">If that doesn't work, copy and paste the following link in your
                                browser:</p>
                            <p style="margin: 0;"><a href="{{ route('password.reset.request',$token) }}"
                                    target="_blank">{{ route('password.reset.request',$token) }}</a></p>
                        </td>
                    </tr>
                    <!-- end copy -->
